...
(defmulti transform "[stream TransformerSupplier Named String]\n[stream TransformerSupplier String]" noah.core/types-vector-varargs)
...
(defmulti left-join "[stream global-table fn-2 fn-2 Named]\nstream global-table fn-2 fn-2]\nstream stream fn-2 join-windows Joined]\nstream stream fn-2 join-windows StreamJoined]\nstream stream fn-2 join-windows]\nstream table fn-2 Joined]\nstream table fn-2]\ntable table Function fn-2 Materialized]\ntable table Function fn-2 Named Materialized]\ntable table Function fn-2 Named]\ntable table Function fn-2]\ntable table fn-2 Materialized]\ntable table fn-2 Named Materialized]\ntable table fn-2 Named]\ntable table fn-2]" noah.core/types-vector)
(defmulti filter-not "[stream fn-2 Named]\nstream fn-2]\ntable fn-2 Materialized]\ntable fn-2 Named Materialized]\ntable fn-2 Named]\ntable fn-2]" noah.core/types-vector)
(defmulti map-values "[stream fn-1 Named]\nstream fn-1]\nstream fn-2 Named]\nstream fn-2]\ntable fn-1 Materialized]\ntable fn-1 Named Materialized]\ntable fn-1 Named]\ntable fn-1]\ntable fn-2 Materialized]\ntable fn-2 Named Materialized]\ntable fn-2 Named]\ntable fn-2]" noah.core/types-vector)
(defmulti through "[stream String produced]\nstream String]" noah.core/types-vector)
(defmulti process "[stream ProcessorSupplier Named String]\nstream ProcessorSupplier String]" noah.core/types-vector-varargs)
(defmulti to-stream "[table Named]\ntable fn-2 Named]\ntable fn-2]\ntable]" noah.core/types-vector)
(defmulti flat-transform "[stream TransformerSupplier Named String]\nstream TransformerSupplier String]" noah.core/types-vector-varargs)
(defmulti print "[stream Printed]" noah.core/types-vector)
(defmulti outer-join "[stream stream fn-2 join-windows Joined]\nstream stream fn-2 join-windows StreamJoined]\nstream stream fn-2 join-windows]\ntable table fn-2 Materialized]\ntable table fn-2 Named Materialized]\ntable table fn-2 Named]\ntable table fn-2]" noah.core/types-vector)
(defmulti merge "[stream stream Named]\nstream stream]" noah.core/types-vector)
...
(defmulti select-key "[stream fn-2 Named]\nstream fn-2]" noah.core/types-vector)
